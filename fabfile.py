...
env.project = 'hive-empire-landing-page'
...
env.virtualenv_path = '~/.virtualenvs/hive-empire/'
...
def staging():
    ...
    env.newrelic_app_name = 'HiveEmpire Staging'

    env.remote_project_path = '/home/ubuntu/apps/hive-empire-landing-page/'
    env.deploy_archive_path = '/home/ubuntu/apps/'
    env.virtualenv_path = '/home/ubuntu/.virtualenvs/hive-empire-landing-page/'
    env.remote_dashboard_path = None

    env.start_service = 'supervisorctl start hive-empire-landing-page'
    env.stop_service = 'supervisorctl stop hive-empire-landing-page'
...
def paths():
    ...
    run('mkdir -p ~/apps/%s/versions/tmp' % env.project)
    run('ln -s ~/apps/%s/versions/tmp ~/apps/%s/current' % (env.project, env.project))
    # pass
